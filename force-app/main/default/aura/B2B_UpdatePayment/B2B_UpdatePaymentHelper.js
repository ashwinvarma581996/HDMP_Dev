({
    doInit : function(component, event) {
        ...
        console.log('getUrlParameter: ',getUrlParameter('orderId'));
        ...
        return (function(a){
            ...
            if (a.getState() === "SUCCESS") {
                ...
                if(res && res.success) {
                    ...
                    component.set("v.orderNumber", res.order.OrderNumber);
                    component.set("v.cartId", res.cartId);
                    component.set("v.orderId", res.order.Id);                    
                    if(res.customerId != ''){
    ...
    submitPaymentByMyPayment : function(component, event) {
        ...
        var action = component.get("c.processPaymentByMyPayment");
        action.setCallback(this, this.submitPaymentByMyPayment_Callback(component, event));
        action.setParams({ 
    ...
    submitPaymentByMyPayment_Callback : function(component, event) {
        return (function(a){
            ...
            if (state === "SUCCESS") {
                ...
                if(res && res.success) {
                    ...
                    window.open('/s/ordersummarypage?orderId='+component.get("v.orderNumber"), '_self');
                } else {
                    component.set("v.showSpinner", false);
                    var errorMessage = '';                    
            ...
            if (state === "SUCCESS") {
                ...
                if(res && res.success) {
                    ...
                    if(res.errorReason && res.errorReason == 'AVS'){
                        ...
                        errorMessage = 'This credit card is already saved. Update your credit card information in your My Payments.';
                    }
