...
const LEFT_SECTION_TITLE_TEXT = {   'Honda' : 'Warranty Information For Honda',
                                    'Acura' : 'Warranty Information For Acura',
                                    'Powersports' : 'Warranty Information For Honda Powersports',
                                    'Power Equipment' : 'Warranty Information For Power Equipment',
                                    'Marine' : 'Warranty Information For Honda Marine products'
                                };

const PC_TEXT =                 {   'Honda' : 'Enter your year, model, and trim for warranty Information about your Honda',
                                    'Acura' : 'Enter your year, model, and trim for warranty Information about your Acura',
                                    'Powersports' : 'Access warranty Information for your Powersports based on its year and category'
                                };
...
export default class ownWarrantySearch extends OwnBaseElement {
...
/*     @track controlArray = [];
    ...
    get vehicleText(){
        switch(this.divisionName){
            case "Honda":
                return {/* bannerText : 'Honda Auto',  */headerText : 'Honda', descriptionText : 'Get Warranty information about your Honda based on its year and model'};
            case "Acura":
                return {/* bannerText : 'Acura Auto',  */headerText : 'Acura', descriptionText : 'Get Warranty information about your Acura based on its year and model'};
            case "Powersports":
                return {/* bannerText : 'Powersports Vehicle',  */headerText : 'Honda Powersports Vehicle', descriptionText : 'Find Warranty details of your Powersports vehicle by selecting its type, model, and trim.'};
            case "Power Equipment":
                return {/* bannerText : 'Power Equipment',  */headerText : 'Honda Power Equipment', descriptionText : 'Find Warranty details of your Power Equipment by selecting a product, type, and model'};
            case "Marine":
                return {/* bannerText : 'Honda Marine Product',  */headerText : 'Honda Marine Product', descriptionText : 'Find Warranty details of your Honda Marine product by selecting an outboard and model'};
        }
    }
    ...
    async connectedCallback(){
        if(this.division == 'Honda'){
            this.isHonda = true;
        }else if(this.division == 'Acura'){
            this.isAcura = true;
        }else if(this.division == 'Powersports'){
            this.isPSP = true;
        }else if(this.division == 'Power Equipment'){
            this.isPE = true;
        }else if(this.division == 'Marine'){
            this.isMarine = true;
        }
        if(this.division == 'Marine' || this.division == 'Power Equipment'){
            this.isPEOrMarine = true;
        }
        // this.initialize();
...
/*         console.log('NAVIGATE');
        ...
        if (this.divisionName == 'Honda' || this.divisionName == 'Acura' || this.divisionName == 'Powersports' || this.divisionName == 'Motorcycle/Powersports'){
            ...
            //sessionStorage.setItem('frompage','Warranty Search: ' + divisionBrandName);
            if(window.location.href.includes('warranty-search')){
                let divisionBrandName = this.division == 'Powerequipment' ? 'Power Equipment' : this.division;
                let bkLink = {
                    label: 'Warranty Search: ' + divisionBrandName,
                    url: window.location.pathname.substring(window.location.pathname.lastIndexOf('/')) + window.location.search
                };
                sessionStorage.setItem('bkLink',JSON.stringify(bkLink));
            }
            sessionStorage.setItem('vinHelpBreadcrumb', 'findProduct');
            ...
            //getProductByVIN({divisionId : this.divisionId === 'PE' ? 'P' : this.divisionId, vin : this.vin})
                ...
                .then(result => {
                    ...
                    if(!prod.isError && prod.modelDetail){
                        ...
                        this.navigate('/find-product-intermediate?page=warranties', {});
                    }else{
                        this.correctVINLength = false;
                        this.incorrectVINLength = true;
                        this.displayVINError = true;
