...
export default class SearchCardCustom extends LightningElement {
     ...
     */
    get fields() {
        var t=  (this.displayData.fields || []).map(({ name, value }, id) => ({
            id: id + 1,
            tabIndex: id === 0 ? 0 : -1,
            ...
            value:
                name === 'Name' || name === 'Description' || name === 'DealerPrice__c' 
                    ? value
                    : `${name}: ${value}`
        }));
    ...
    get dealerPrice() {
        ...
        //console.log(this.displayData.DealerPrice__c);
        return this.displayData.DealerPrice__c[0] ;
    ...
    get hasDealerPrice() {
        //console.log('DealerPrice__c='+this.displayData.DealerPrice__c);
        //return true;
        return ( this.displayData.DealerPrice__c===undefined ?false:true);
        //return ( this.displayData.DealerPrice__c===undefined ?false:this.displayData.DealerPrice__c ==''? false : 'undefined'?false:true) ;
    }
    ...
    get cardContainerClass() {
        return this.config.resultsLayout === 'grid'
            ? 'slds-box card-layout-grid background1'
            : 'card-layout-list';
    }
