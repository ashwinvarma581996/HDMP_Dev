...
/*import DisplayImage from '@salesforce/contentAssetUrl/No_Image';*/
...
export default class ProductDetailsDisplay extends NavigationMixin(
    ...
    navigateToBack(event){
        ...
        //console.log('called navigateToBack ');
