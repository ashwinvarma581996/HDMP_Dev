...
export default class PayPalOrderConfirmation extends NavigationMixin(LightningElement) {
    ...
    connectedCallback() {
        ...
        //for adobe: starts
        const message = { message: { 'eventType': DATALAYER_EVENT_TYPE.LOAD, confirmationOrderId: this.orderId } };//for adobe bug 29
 ...
 if(this.cartItems){
    ...
    //for R2 story: added by Yashika: HDMP-6314 - start  here
